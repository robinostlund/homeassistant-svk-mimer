...
def update_manifest():
    ...
    # read manifest
    with open(f"{os.getcwd()}/custom_components/svk_mimer/manifest.json") as manifestfile:
    ...
    # save manifest
    with open(f"{os.getcwd()}/custom_components/svk_mimer/manifest.json", "w") as manifestfile:
