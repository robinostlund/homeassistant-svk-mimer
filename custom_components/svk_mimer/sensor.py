...
SENSOR_TYPES: tuple[SensorEntityDescription, ...] = (
    ...
    SVKMimerSensorEntityDescription(
        ...
        device_class=SensorDeviceClass.MONETARY,
        native_unit_of_measurement=f"{CURRENCY}",
        value_fn=lambda data: data.prices_fcr_d,
        config_entry=CONF_SUBSCRIBING_FCR_D,
    ),
    SVKMimerSensorEntityDescription(
    ...
    SVKMimerSensorEntityDescription(
        key="earnings_today_fcr_d",
        name="Earnings Today FCR-D",
        icon="mdi:cash",
        entity_registry_enabled_default=True,
        # entity_category=EntityCategory.DIAGNOSTIC,
        state_class=SensorStateClass.TOTAL,
    ...
    SVKMimerSensorEntityDescription(
        key="earnings_total_fcr_d",
        name="Earnings Total FCR-D",
        icon="mdi:cash",
        entity_registry_enabled_default=True,
        # entity_category=EntityCategory.DIAGNOSTIC,
        state_class=SensorStateClass.TOTAL,
    ...
    SVKMimerSensorEntityDescription(
        key="list_price_fcr_d",
        name="List Price FCR-D",
        icon="mdi:cash",
        entity_registry_enabled_default=True,
        # entity_category=EntityCategory.DIAGNOSTIC,
        state_class=SensorStateClass.TOTAL,
        ...
        native_unit_of_measurement=f"{CURRENCY}/kW",
        value_fn=lambda data: data.prices_fcr_d,
        config_entry=CONF_MONITOR_FCR_D,
    ),
    SVKMimerSensorEntityDescription(
